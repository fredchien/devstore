...
export default async function Home() {
  ...
  return (
    <div className="grid max-h-[860px] grid-cols-9 grid-row-6 gap-6">
      <Link href={`/product/${highlightedProducts.slug}`} className="group relative col-span-6 row-span-6 rounded-lg bg-zinc-900 overflow-hidden flex justify-center items-end">
        <Image 
